...
/**
 * OnboardingScreen2 Component
 * Second screen of the onboarding flow
 * Displays information about toxin-free groceries
 */
const OnboardingScreen2: React.FC<OnboardingScreen2Props> = ({
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      //   from_screen: 'onboarding_2',
      //   to_screen: 'onboarding_3',
      // });

      if (onNext) {
        onNext();
      } else {
        // Default navigation behavior - Navigate to OnboardingScreen3
