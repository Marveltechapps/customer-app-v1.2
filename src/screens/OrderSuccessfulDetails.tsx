...
const DUMMY_ORDER_DETAILS: OrderDetails = {
  ...
  orderTime: '08:50 am',
  deliveryDate: '21st Jun 2024, 10:30 am',
  arrivedIn: '6 MINS',
  products: [
  ...
  totalAmount: '₹131',
  savedAmount: '₹63',
  deliveryAddress: '3th, floor, Vasatha bhavan, Adyar, Chennai. 600 021',
  orderId: '#1CEDGDFLK41662',
  orderPlacedDate: '3 Dec 2024, 02.15 PM',
};

const OrderSuccessfulDetails: React.FC = () => {
    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      >
        <View style={styles.statusContainer}>
          <View style={styles.statusHeaderRow}>
            ...
            {orderDetails.arrivedIn && (
              <View style={styles.arrivedInBadge}>
                <Text style={styles.arrivedInText}>Arrived in </Text>
                <View style={styles.arrivedInTimeBadge}>
                  <ClockIcon width={12} height={12} />
                  <Text style={styles.arrivedInTime}>{orderDetails.arrivedIn}</Text>
                </View>
              </View>
            )}
          </View>
        ...
        <View style={styles.orderDetailsCard}>
          ...
          <View style={styles.orderDetailsRow}>
            ...
            <Text style={styles.orderDetailsValue}>{orderDetails.deliveryAddress || 'N/A'}</Text>
          </View>
          <View style={styles.orderDetailsRow}>
      ...
      <View style={styles.fixedActionsContainer}>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text style={styles.rateOrderButtonText}>Rate order</Text>
        </TouchableOpacity>
        <TouchableOpacity
...
export default OrderSuccessfulDetails;
